...
Scene::Scene() : bvh(nullptr), pm(nullptr)
{}
...
//void Scene::SetCamera(const CameraThinFilm &c)
//{
//    cameratf = CameraThinFilm(c);
//    cameratf.create();
//    film.SetDimensions(c.width, c.height);
//}
...
#if THINFILM == 1
    camera = Camera(400, 400, Point3f(5, 8, -5), Point3f(0,0,0), Vector3f(0,1,0),5);
#else
