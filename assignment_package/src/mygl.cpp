...
void MyGL::RenderScene()
{
    ...
    if(makeBVH && !scene.bvh)
    {
        ...
        std::cout << "\nBVHAccel execution time(ms): " << elapsed << "\n";
    }
...
//            Point2i debugPixel(105,181);//topleft box, twolights, 364,8 upper right corner
            Point2i debugPixel(122,293);//topleft box, twolights, 364,8 upper right corner
